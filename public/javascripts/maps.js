$(document).ready(function(){
  var chicagoMap = drawMap();
  addMapMarkers(chicagoData, chicagoMap);
});
...
var drawMap = function(){
    ...
    return var chicagoMap = new google.maps.Map($('.map-canvas'), mapOptions);
}

var createMapMarker = function(dataRecord, map){
...
var addMapMarkers = function(chicagoData, map){
